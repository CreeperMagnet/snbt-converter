...
config.py determines which folder will be targeted by the stringify/unstringify scripts.
...
The expected version ids can be found on the [version manifest](https://launchermeta.mojang.com/mc/game/version_manifest.json).
